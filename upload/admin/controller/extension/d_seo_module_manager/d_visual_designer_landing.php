<?php
class ControllerExtensionDSEOModuleManagerDVisualDesignerLanding extends Controller
{
    private $codename = 'd_visual_designer_landing';
    private $route = 'extension/d_seo_module_manager/d_visual_designer_landing';
