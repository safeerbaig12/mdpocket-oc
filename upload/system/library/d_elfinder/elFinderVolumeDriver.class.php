...
abstract class elFinderVolumeDriver {
    ...
    protected function tmbname($stat) {
        if($stat['mime'] == 'image/svg+xml'){
            return $stat['hash'].$stat['ts'].'.svg';
        } else if($stat['mime'] == 'image/x-ico') {
            return $stat['hash'].$stat['ts'].'.ico';
        } else {
    ...
    protected function canCreateTmb($path, $stat) {
        return $this->tmbPathWritable
            ...
            && ($this->imgLib == 'gd' ? $stat['mime'] == 'image/jpeg' || $stat['mime'] == 'image/png' || $stat['mime'] == 'image/gif' || $stat['mime'] == 'image/x-ico'  || $stat['mime'] == 'image/svg+xml' : true);
    }
    ...
    protected function createTmb($path, $stat) {
        ...
        if($stat['mime'] == 'image/svg+xml' || $stat['mime'] == 'image/x-ico') {
            file_put_contents($tmb, file_get_contents($path));
